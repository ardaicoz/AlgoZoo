...
public class TestModeGUI extends javax.swing.JPanel {
   ...
   public void initLevels() {
      ...
      TestLevels level6 = new TestLevels(7, 10, 2, 7, new ArrayList<Character>(Arrays.asList('a', 'w', 'a', 'w', 'f', 'a', 'w', 'a', 'a')), new ArrayList<Character>(Arrays.asList('d', 's', 'a', 'f', 'a', 'w', 'w', 's', 's')), new ArrayList<Character>(Arrays.asList('s', 'd', 'd', 'd', 'w', 's', 'f', 'w', 'w')), new ImageIcon(getClass().getResource("/algoZoo/Maps/TestMode/Level6.png")), 6);
      TestLevels level7 = new TestLevels(8, 10, 4, 5, new ArrayList<Character>(Arrays.asList('s', 'a', 'w', 'd', 'f', 'd', 'a', 'a', 'w', 'w')), new ArrayList<Character>(Arrays.asList('d', 'w', 'f', 's', 's', 'd', 'w', 'd', 'w', 'd')), new ArrayList<Character>(Arrays.asList('a', 'w', 'a', 'w', 'a', 'w', 'f', 'a', 'w', 'w')), new ImageIcon(getClass().getResource("/algoZoo/Maps/TestMode/Level7.png")), 7);
      TestLevels level8 = new TestLevels(9, 7, 7, 5, new ArrayList<Character>(Arrays.asList('d', 'a', 'a', 'a', 'f', 'a', 'w', 'w', 's')), new ArrayList<Character>(Arrays.asList('w', 'w', 's', 's', 'w', 'f', 'd', 'd', 'd')), new ArrayList<Character>(Arrays.asList('w', 'd', 'w', 'w', 'f', 'a', 's', 'a', 'a')), new ImageIcon(getClass().getResource("/algoZoo/Maps/TestMode/Level8.png")), 8);
      TestLevels level9 = new TestLevels(7, 8, 5, 5, new ArrayList<Character>(Arrays.asList('a', 'd', 'a', 'f', 'd', 'd', 's', 'a', 'd', 'w')), new ArrayList<Character>(Arrays.asList('d', 'w', 'w', 'w', 'a', 's', 'f', 'a', 'w', 'a')), new ArrayList<Character>(Arrays.asList('d', 'a', 'w', 'f', 'a', 'a', 'a', 'a', 'w', 'd')), new ImageIcon(getClass().getResource("/algoZoo/Maps/TestMode/Level9.png")), 9);
      TestLevels level10 = new TestLevels(10, 9, 3, 9, new ArrayList<Character>(Arrays.asList('a', 'a', 's', 'f', 'a', 'w', 'a', 'a', 'a', 'a')), new ArrayList<Character>(Arrays.asList('d', 'a', 'f', 'w', 's', 'w', 'w', 'w', 'a', 'd')), new ArrayList<Character>(Arrays.asList('d', 'a', 's', 'a', 'w', 's', 'd', 'f', 'a', 'w')), new ImageIcon(getClass().getResource("/algoZoo/Maps/TestMode/Level10.png")), 10);
